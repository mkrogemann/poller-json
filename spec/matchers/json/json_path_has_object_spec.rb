        ...
        context 'Document has the expected JSON Object' do
          ...
          context 'given as a Hash' do
            it 'returns true if given JSONPath holds the expected JSON Object' do
              jho = JSONPathHasObject.new('$menu.popup.menuitem[2]', ::JSON.parse(sample_json_object_string))
              jho.matches?(sample_json_string).should be_true
            end
          end

          context 'given as a String' do
            it 'returns true if given JSONPath holds the expected JSON Object' do
              jho = JSONPathHasObject.new('$menu.popup.menuitem[2]', sample_json_object_string)
              jho.matches?(sample_json_string).should be_true
            end
          end
