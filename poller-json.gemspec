...
Gem::Specification.new do |gem|
  ...
  gem.add_runtime_dependency('multi_json', '~> 1.8.2') if RUBY_VERSION != '1.8.7' and RUBY_ENGINE != 'rbx'
  gem.add_runtime_dependency('json', '~> 1.8.1') if RUBY_VERSION == '1.8.7' and RUBY_ENGINE != 'rbx'   
  gem.add_runtime_dependency('rubysl', '~> 2.0') if RUBY_ENGINE == 'rbx'
  gem.add_runtime_dependency('rubysl-json', '~> 2.0.2') if RUBY_ENGINE == 'rbx'
